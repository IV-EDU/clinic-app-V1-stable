...
I18N: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "reception_approve_confirmation_label": "I confirm this draft should create the live patient and treatment now.",
    ...
    "ar": {
        ...
        "reception_approve_confirmation_label": "أؤكد أن هذه المسودة يجب أن تنشئ ملف المريض والعلاج المباشر الآن.",
