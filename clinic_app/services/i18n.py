...
I18N: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "reception_manager_placeholder_title": "Manager queue coming next",
        "reception_manager_placeholder_body": "Review and approval tools are not in this slice yet. This page only enables draft entry for now.",
    ...
    "ar": {
        ...
        "reception_manager_placeholder_title": "قائمة المدير قادمة لاحقاً",
        "reception_manager_placeholder_body": "أدوات المراجعة والموافقة ليست ضمن هذه المرحلة بعد. هذه الصفحة مخصصة لإدخال المسودات فقط حالياً.",
