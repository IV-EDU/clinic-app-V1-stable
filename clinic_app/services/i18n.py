...
I18N: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "manage_patient_records": "Manage and view patient records",
        "outstanding_balances": "With Balance",
        "balance_filter_label": "Filter by balance",
        "balance_filter_all": "All",
        "balance_filter_owed": "With Balance",
        "balance_filter_paid": "Paid Up",
        "this_week": "this week",
        "showing": "Showing",
        "of": "of",
        "todays_appointments_title": "Today's Appointments",
        ...
        "after": "After",
        "current": "Current",
        "audit_deleted_value": "Deleted",
        "audit_created_value": "Value",
        ...
        "reception_desk_title": "Reception Desk",
        "reception_desk_subtitle": "Create draft treatment entries without touching the live patient file.",
        "reception_open_drafts": "Open drafts",
        "reception_returned_label": "Returned / needs changes",
        "reception_waiting_review": "Waiting review",
        "reception_new_submission": "New submission",
        "reception_entry_kind_label": "Entry type",
        "reception_entry_kind_treatment": "Treatment",
        "reception_entry_kind_visit_only": "Visit only",
        "reception_money_received_today": "Money received today",
        "reception_submit_draft": "Send for review",
        "reception_draft_saved": "Draft sent for manager review.",
        "reception_draft_resubmitted": "Draft updated and sent back for manager review.",
        "reception_my_recent_drafts": "My recent drafts",
        "reception_no_drafts_yet": "No drafts yet.",
        "reception_status_waiting_review": "Waiting Review",
        "reception_status_returned": "Returned",
        "reception_status_held": "Held",
        "reception_status_approved": "Approved",
        "reception_status_rejected": "Rejected",
        "reception_section_navigation": "Reception sections",
        "reception_nav_desk": "Desk",
        "reception_nav_queue": "Manager Queue",
        "reception_nav_history": "History",
        "reception_open_draft": "Open draft",
        "reception_edit_draft": "Edit Draft",
        "reception_review_draft": "Review draft",
        "reception_edit_title": "Edit returned draft",
        "reception_edit_subtitle": "Update the requested details and send the draft back to the manager queue.",
        "reception_resubmit_draft": "Save changes and resubmit",
        "reception_action_edit": "Edit draft",
        "reception_manager_save_draft": "Save draft changes",
        "reception_draft_updated": "Draft changes were saved.",
        "reception_manager_edit_treatment_entry_title": "Edit pending treatment draft",
        "reception_manager_edit_treatment_entry_subtitle": "Update this pending treatment draft without posting live data yet.",
        "reception_manager_edit_new_payment_title": "Edit pending payment draft",
        "reception_manager_edit_new_payment_subtitle": "Update this pending payment draft without posting it to the live treatment yet.",
        "reception_manager_edit_payment_title": "Edit pending payment correction",
        "reception_manager_edit_payment_subtitle": "Update this pending payment correction without changing the live payment yet.",
        "reception_manager_edit_treatment_title": "Edit pending treatment correction",
        "reception_manager_edit_treatment_subtitle": "Update this pending treatment correction without changing the live treatment yet.",
        "reception_manager_edit_patient_title": "Edit pending patient correction",
        "reception_manager_edit_patient_subtitle": "Update this pending patient correction without changing the live patient profile yet.",
        "reception_manager_queue_ready_title": "Manager review is ready",
        "reception_manager_queue_ready_body": "Managers can now review pending drafts without touching live patient or payment data.",
        "reception_open_manager_queue": "Open manager queue",
        "reception_manager_queue_title": "Pending manager queue",
        "reception_manager_queue_empty": "No drafts are waiting for manager review.",
        "reception_detail_title": "Draft details",
        "reception_history_title": "Workflow history",
        "reception_history_empty": "No workflow history yet.",
        "reception_history_feed_title": "Reception history",
        "reception_history_feed_empty": "No workflow activity yet.",
        "reception_history_actor_label": "Actor",
        "reception_history_source_desk": "Reception Desk",
        "reception_history_source_patient_file": "Patient File",
        "reception_history_source_treatment_card": "Treatment Card",
        "reception_history_kind_new_treatment": "New treatment draft",
        "reception_history_kind_new_payment": "New payment draft",
        "reception_history_kind_visit_only": "Visit-only draft",
        "reception_history_action_submitted": "Submitted",
        "reception_history_action_edited": "Edited",
        "reception_history_action_returned": "Returned",
        "reception_history_action_held": "Held",
        "reception_history_action_rejected": "Rejected",
        "reception_history_action_approved": "Approved",
        "reception_review_actions_title": "Review actions",
        "reception_hold_note": "Hold note",
        "reception_return_reason": "Return reason",
        "reception_reject_reason": "Reject reason",
        "reception_manager_note": "Manager note",
        "reception_warnings_title": "Draft warnings",
        "reception_action_hold": "Hold draft",
        "reception_action_return": "Return for changes",
        "reception_action_reject": "Reject draft",
        "reception_action_approve": "Approve and post",
        "reception_approval_route_title": "Approval route",
        "reception_approval_route_create_new": "Create new patient",
        "reception_approval_route_create_new_help": "Create a brand-new live patient file, then post this treatment there.",
        "reception_approval_route_attach_existing": "Attach to existing patient",
        "reception_approval_route_attach_existing_help": "Keep the existing patient profile unchanged and post only the treatment onto that file.",
        "reception_existing_patient_candidates_title": "Possible existing patients",
        "reception_existing_patient_candidates_empty": "No likely existing patients were found from this draft's current clues.",
        "reception_existing_patient_selected_title": "Selected existing patient",
        "reception_existing_patient_search_label": "Find a different existing patient",
        "reception_existing_patient_search_placeholder": "Search by name, phone, file number, or page number",
        "reception_existing_patient_search_button": "Search",
        "reception_existing_patient_search_empty": "No existing patients matched that search.",
        "reception_existing_patient_search_error": "Search failed. Try again.",
        "reception_approve_confirmation_label": "I confirm this draft should post the selected live treatment now.",
        "reception_visit_approve_confirmation_label": "I confirm this draft should post the live visit-only entry now.",
        "reception_approve_confirmation_required": "Final approval confirmation is required.",
        "reception_draft_held": "Draft moved to held.",
        "reception_draft_returned": "Draft returned to reception for changes.",
        "reception_draft_rejected": "Draft rejected.",
        "reception_draft_approved": "Draft approved and posted to the live patient file.",
        "reception_return_reason_required": "Return reason is required.",
        "reception_reject_reason_required": "Rejection reason is required.",
        "reception_live_record_title": "Live record",
        "reception_open_live_patient": "Open live patient file",
        "reception_unknown_patient": "Unnamed patient",
        "reception_no_treatment_text": "No treatment text",
        "reception_send_treatment_draft": "Send Treatment Draft",
        "reception_send_visit_draft": "Send Visit-Only Draft",
        "reception_new_treatment_title": "New treatment draft",
        "reception_new_treatment_subtitle": "Create a locked treatment draft for this patient file without posting it to the live record yet.",
        "reception_create_treatment_draft": "Send treatment draft for review",
        "reception_new_treatment_draft_saved": "Treatment draft was sent for manager review.",
        "reception_new_visit_title": "New visit-only draft",
        "reception_new_visit_subtitle": "Create a locked visit-only draft for this patient file without posting it to the live record yet.",
        "reception_create_visit_draft": "Send visit-only draft for review",
        "reception_new_visit_draft_saved": "Visit-only draft was sent for manager review.",
        "reception_edit_visit_title": "Edit returned visit-only draft",
        "reception_edit_visit_subtitle": "Update the returned visit-only draft and send it back to the manager queue.",
        "reception_manager_edit_visit_title": "Edit pending visit-only draft",
        "reception_manager_edit_visit_subtitle": "Update this pending visit-only draft without posting it live yet.",
        "reception_visit_draft_approved": "Visit-only draft was approved and posted to the live patient file.",
        "reception_locked_patient_summary": "Locked patient summary",
        "reception_send_payment_draft": "Send Payment Draft",
        "reception_send_payment_correction": "Send Payment Correction",
        "reception_new_payment_title": "New payment draft",
        "reception_new_payment_subtitle": "Create a locked payment draft for one existing treatment without posting it live yet.",
        "reception_locked_treatment_summary": "Locked treatment summary",
        "reception_paid_so_far": "Paid so far",
        "reception_current_remaining": "Current remaining",
        "reception_submitted_amount": "Submitted amount",
        "reception_submitted_snapshot_remaining": "Remaining at submission",
        "reception_live_remaining_changed": "The live remaining balance changed after this draft was submitted. Approval will re-check the current remaining amount.",
        "reception_create_payment_draft": "Send payment draft for review",
        "reception_payment_draft_saved": "Payment draft was sent for manager review.",
        "reception_payment_draft_approved": "Payment draft was approved and posted to the live treatment.",
        "reception_payment_approve_confirmation_label": "I confirm this draft should post the live payment onto the locked treatment now.",
        "reception_payment_correction_title": "New payment correction draft",
        "reception_payment_correction_subtitle": "Propose updates to one existing payment without editing the live record directly now.",
        "reception_edit_payment_title": "Edit returned payment correction",
        "reception_edit_payment_subtitle": "Update the returned payment correction, then send it back to the manager queue.",
        "reception_payment_correction_kind": "Payment correction",
        "reception_payment_save_draft": "Send payment correction for review",
        "reception_payment_correction_draft_saved": "Payment correction draft was sent for manager review.",
        "reception_payment_correction_draft_approved": "Payment correction was approved and applied to the live payment.",
        "reception_payment_current_snapshot": "Current payment snapshot",
        "reception_payment_proposed_changes": "Proposed payment changes",
        "reception_payment_row_type": "Payment row type",
        "reception_payment_initial_row": "Initial payment",
        "reception_payment_child_row": "Later payment",
        "reception_edit_payment_approve_confirmation_label": "I confirm this draft should update the locked live payment now.",
        "reception_send_treatment_correction": "Send Treatment Correction",
        "reception_treatment_correction_title": "New treatment correction draft",
        "reception_treatment_correction_subtitle": "Propose updates to one existing treatment without editing the live record directly now.",
        "reception_edit_treatment_title": "Edit returned treatment correction",
        "reception_edit_treatment_subtitle": "Update the returned treatment correction, then send it back to the manager queue.",
        "reception_treatment_correction_kind": "Treatment correction",
        "reception_treatment_save_draft": "Send treatment correction for review",
        "reception_treatment_draft_saved": "Treatment correction draft was sent for manager review.",
        "reception_treatment_draft_approved": "Treatment correction was approved and applied to the live treatment.",
        "reception_treatment_current_snapshot": "Current treatment snapshot",
        "reception_treatment_proposed_changes": "Proposed treatment changes",
        "reception_treatment_approve_confirmation_label": "I confirm this draft should update the live treatment now.",
        "reception_send_patient_correction": "Send Patient Correction",
        "reception_patient_correction_title": "New patient correction draft",
        "reception_patient_correction_subtitle": "Propose updates to one existing patient file without editing the live record directly now.",
        "reception_edit_patient_title": "Edit returned patient correction",
        "reception_edit_patient_subtitle": "Update the returned patient correction, then send it back to the manager queue.",
        "reception_patient_correction_kind": "Patient correction",
        "reception_patient_save_draft": "Send patient correction for review",
        "reception_patient_draft_saved": "Patient correction draft was sent for manager review.",
        "reception_patient_draft_approved": "Patient correction was approved and applied to the live patient profile.",
        "reception_patient_current_profile": "Current patient profile",
        "reception_patient_proposed_profile": "Proposed patient profile",
        "reception_patient_approve_confirmation_label": "I confirm this draft should update the live patient profile now.",
        "reception_receptionist_note": "Reception note",
        "reception_draft_type_label": "Draft type",
    },
    "ar": {
        ...
        "search_patients_placeholder": "ابحث عن مريض...",
        "search": "بحث",
        "matched": "مطابق",
        "clear": "مسح",
        "sort_oldest_first": "الأقدم أولاً",
        "sort_newest_first": "الأحدث أولاً",
        "dashboard_overview": "لوحة التحكم",
        "dashboard_subtitle": "إليك ما يحدث اليوم.",
        "todays_collections": "تحصيلات اليوم",
        "recent_patients": "أحدث المرضى",
        "manage_patient_records": "إدارة وعرض سجلات المرضى",
        "outstanding_balances": "برصيد مستحق",
        "balance_filter_label": "تصفية حسب الرصيد",
        "balance_filter_all": "الكل",
        "balance_filter_owed": "برصيد مستحق",
        "balance_filter_paid": "مسدد بالكامل",
        "this_week": "هذا الأسبوع",
        "showing": "عرض",
        "of": "من",
        "todays_appointments_title": "مواعيد اليوم",
        "no_appointments_today": "لا مواعيد اليوم",
        "quick_actions": "إجراءات سريعة",
        "view_all_patients": "عرض جميع المرضى",
        "view_all": "عرض الكل",
        "patients": "عدد المرضى",
        "no_patients_found": "لا توجد نتائج",
        "view_all_results_for": "عرض كل النتائج لـ",
        ...
        "after": "بعد",
        "current": "الحالي",
        "audit_deleted_value": "محذوف",
        "audit_created_value": "القيمة",
        ...
        "reception_desk_title": "مكتب الاستقبال",
        "reception_desk_subtitle": "أنشئ مسودات علاج بدون تعديل ملف المريض المباشر.",
        "reception_open_drafts": "المسودات المفتوحة",
        "reception_returned_label": "معاد / يحتاج تعديل",
        "reception_waiting_review": "بانتظار المراجعة",
        "reception_new_submission": "إرسال جديد",
        "reception_entry_kind_label": "نوع الإدخال",
        "reception_entry_kind_treatment": "علاج",
        "reception_entry_kind_visit_only": "زيارة فقط",
        "reception_money_received_today": "تم استلام مبلغ اليوم",
        "reception_submit_draft": "إرسال للمراجعة",
        "reception_draft_saved": "تم إرسال المسودة لمراجعة المدير.",
        "reception_draft_resubmitted": "تم تحديث المسودة وإعادتها إلى قائمة مراجعة المدير.",
        "reception_my_recent_drafts": "مسوداتي الأخيرة",
        "reception_no_drafts_yet": "لا توجد مسودات بعد.",
        "reception_status_waiting_review": "بانتظار المراجعة",
        "reception_status_returned": "معاد",
        "reception_status_held": "معلّق",
        "reception_status_approved": "تمت الموافقة",
        "reception_status_rejected": "مرفوض",
        "reception_section_navigation": "أقسام الاستقبال",
        "reception_nav_desk": "المكتب",
        "reception_nav_queue": "قائمة المدير",
        "reception_nav_history": "السجل",
        "reception_open_draft": "فتح المسودة",
        "reception_edit_draft": "تعديل المسودة",
        "reception_review_draft": "مراجعة المسودة",
        "reception_edit_title": "تعديل المسودة المعادة",
        "reception_edit_subtitle": "حدّث البيانات المطلوبة ثم أعد إرسال المسودة إلى قائمة المدير.",
        "reception_resubmit_draft": "حفظ التعديلات وإعادة الإرسال",
        "reception_action_edit": "تعديل المسودة",
        "reception_manager_save_draft": "حفظ تعديلات المسودة",
        "reception_draft_updated": "تم حفظ تعديلات المسودة.",
        "reception_manager_edit_treatment_entry_title": "تعديل مسودة علاج معلقة",
        "reception_manager_edit_treatment_entry_subtitle": "حدّث مسودة العلاج المعلقة بدون نشر أي بيانات مباشرة بعد.",
        "reception_manager_edit_new_payment_title": "تعديل مسودة دفعة معلقة",
        "reception_manager_edit_new_payment_subtitle": "حدّث مسودة الدفعة المعلقة بدون نشرها على العلاج المباشر بعد.",
        "reception_manager_edit_payment_title": "تعديل تصحيح دفعة معلق",
        "reception_manager_edit_payment_subtitle": "حدّث تصحيح الدفعة المعلق بدون تغيير الدفعة المباشرة بعد.",
        "reception_manager_edit_treatment_title": "تعديل تصحيح علاج معلق",
        "reception_manager_edit_treatment_subtitle": "حدّث تصحيح العلاج المعلق بدون تغيير العلاج المباشر بعد.",
        "reception_manager_edit_patient_title": "تعديل تصحيح مريض معلق",
        "reception_manager_edit_patient_subtitle": "حدّث تصحيح المريض المعلق بدون تغيير ملف المريض المباشر بعد.",
        "reception_manager_queue_ready_title": "مراجعة المدير أصبحت جاهزة",
        "reception_manager_queue_ready_body": "يمكن للمدير الآن مراجعة المسودات المعلقة بدون تعديل بيانات المرضى أو الدفعات المباشرة.",
        "reception_open_manager_queue": "فتح قائمة المدير",
        "reception_manager_queue_title": "المسودات بانتظار المدير",
        "reception_manager_queue_empty": "لا توجد مسودات بانتظار مراجعة المدير.",
        "reception_detail_title": "تفاصيل المسودة",
        "reception_history_title": "سجل سير العمل",
        "reception_history_empty": "لا يوجد سجل سير عمل بعد.",
        "reception_history_feed_title": "سجل الاستقبال",
        "reception_history_feed_empty": "لا يوجد نشاط سير عمل بعد.",
        "reception_history_actor_label": "المنفذ",
        "reception_history_source_desk": "مكتب الاستقبال",
        "reception_history_source_patient_file": "ملف المريض",
        "reception_history_source_treatment_card": "بطاقة العلاج",
        "reception_history_kind_new_treatment": "مسودة علاج جديدة",
        "reception_history_kind_new_payment": "مسودة دفعة جديدة",
        "reception_history_kind_visit_only": "مسودة زيارة فقط",
        "reception_history_action_submitted": "تم الإرسال",
        "reception_history_action_edited": "تم التعديل",
        "reception_history_action_returned": "تم الإرجاع",
        "reception_history_action_held": "تم التعليق",
        "reception_history_action_rejected": "تم الرفض",
        "reception_history_action_approved": "تم الاعتماد",
        "reception_review_actions_title": "إجراءات المراجعة",
        "reception_hold_note": "ملاحظة التعليق",
        "reception_return_reason": "سبب الإرجاع",
        "reception_reject_reason": "سبب الرفض",
        "reception_manager_note": "ملاحظة المدير",
        "reception_warnings_title": "تنبيهات المسودة",
        "reception_action_hold": "تعليق المسودة",
        "reception_action_return": "إرجاع للتعديل",
        "reception_action_reject": "رفض المسودة",
        "reception_action_approve": "اعتماد ونشر",
        "reception_approval_route_title": "مسار الاعتماد",
        "reception_approval_route_create_new": "إنشاء مريض جديد",
        "reception_approval_route_create_new_help": "أنشئ ملف مريض مباشر جديد ثم انشر هذا العلاج عليه.",
        "reception_approval_route_attach_existing": "ربط بملف مريض موجود",
        "reception_approval_route_attach_existing_help": "أبقِ بيانات المريض الحالية كما هي وانشر العلاج فقط على نفس الملف.",
        "reception_existing_patient_candidates_title": "مرضى موجودون محتملون",
        "reception_existing_patient_candidates_empty": "لم يتم العثور على مرضى محتملين من بيانات هذه المسودة الحالية.",
        "reception_existing_patient_selected_title": "ملف المريض المحدد",
        "reception_existing_patient_search_label": "ابحث عن ملف مريض موجود آخر",
        "reception_existing_patient_search_placeholder": "ابحث بالاسم أو الهاتف أو رقم الملف أو رقم الصفحة",
        "reception_existing_patient_search_button": "بحث",
        "reception_existing_patient_search_empty": "لا يوجد مرضى مطابقون لهذا البحث.",
        "reception_existing_patient_search_error": "فشل البحث. حاول مرة أخرى.",
        "reception_approve_confirmation_label": "أؤكد أن هذه المسودة يجب أن تنشر العلاج المباشر المحدد الآن.",
        "reception_visit_approve_confirmation_label": "أؤكد أن هذه المسودة يجب أن تنشر زيارة فقط في السجل المباشر الآن.",
        "reception_approve_confirmation_required": "تأكيد الاعتماد النهائي مطلوب.",
        "reception_draft_held": "تم نقل المسودة إلى حالة التعليق.",
        "reception_draft_returned": "تم إرجاع المسودة إلى الاستقبال للتعديل.",
        "reception_draft_rejected": "تم رفض المسودة.",
        "reception_draft_approved": "تم اعتماد المسودة ونشرها في ملف المريض المباشر.",
        "reception_return_reason_required": "سبب الإرجاع مطلوب.",
        "reception_reject_reason_required": "سبب الرفض مطلوب.",
        "reception_live_record_title": "السجل المباشر",
        "reception_open_live_patient": "فتح ملف المريض المباشر",
        "reception_unknown_patient": "مريض بدون اسم",
        "reception_no_treatment_text": "لا يوجد وصف علاج",
        "reception_send_treatment_draft": "إرسال مسودة علاج",
        "reception_send_visit_draft": "إرسال مسودة زيارة فقط",
        "reception_new_treatment_title": "مسودة علاج جديدة",
        "reception_new_treatment_subtitle": "أنشئ مسودة علاج مقفلة لهذا المريض بدون نشرها مباشرة في السجل الآن.",
        "reception_create_treatment_draft": "إرسال مسودة العلاج للمراجعة",
        "reception_new_treatment_draft_saved": "تم إرسال مسودة العلاج لمراجعة المدير.",
        "reception_new_visit_title": "مسودة زيارة فقط جديدة",
        "reception_new_visit_subtitle": "أنشئ مسودة زيارة فقط مقفلة لهذا المريض بدون نشرها مباشرة في السجل الآن.",
        "reception_create_visit_draft": "إرسال مسودة زيارة فقط للمراجعة",
        "reception_new_visit_draft_saved": "تم إرسال مسودة زيارة فقط لمراجعة المدير.",
        "reception_edit_visit_title": "تعديل مسودة زيارة فقط المعادة",
        "reception_edit_visit_subtitle": "حدّث مسودة زيارة فقط المعادة ثم أعد إرسالها إلى قائمة المدير.",
        "reception_manager_edit_visit_title": "تعديل مسودة زيارة فقط معلقة",
        "reception_manager_edit_visit_subtitle": "حدّث مسودة زيارة فقط المعلقة بدون نشرها مباشرة في السجل بعد.",
        "reception_visit_draft_approved": "تم اعتماد مسودة زيارة فقط ونشرها في ملف المريض المباشر.",
        "reception_locked_patient_summary": "ملخص المريض المقفل",
        "reception_send_payment_draft": "إرسال مسودة دفعة",
        "reception_send_payment_correction": "إرسال تصحيح دفعة",
        "reception_new_payment_title": "مسودة دفعة جديدة",
        "reception_new_payment_subtitle": "أنشئ مسودة دفعة مرتبطة بعلاج موجود بدون نشرها مباشرة الآن.",
        "reception_locked_treatment_summary": "ملخص العلاج المقفل",
        "reception_paid_so_far": "المدفوع حتى الآن",
        "reception_current_remaining": "المتبقي الحالي",
        "reception_submitted_amount": "المبلغ المرسل",
        "reception_submitted_snapshot_remaining": "المتبقي وقت الإرسال",
        "reception_live_remaining_changed": "الرصيد المتبقي المباشر تغير بعد إرسال هذه المسودة. سيُعاد فحص المتبقي الحالي وقت الاعتماد.",
        "reception_create_payment_draft": "إرسال مسودة الدفعة للمراجعة",
        "reception_payment_draft_saved": "تم إرسال مسودة الدفعة لمراجعة المدير.",
        "reception_payment_draft_approved": "تم اعتماد مسودة الدفعة ونشرها على العلاج المباشر.",
        "reception_payment_approve_confirmation_label": "أؤكد أن هذه المسودة يجب أن تضيف الدفعة المباشرة على العلاج المقفل الآن.",
        "reception_payment_correction_title": "مسودة تصحيح دفعة",
        "reception_payment_correction_subtitle": "اقترح تعديل دفعة موجودة بدون تعديل السجل المباشر الآن.",
        "reception_edit_payment_title": "تعديل تصحيح الدفعة المُعادة",
        "reception_edit_payment_subtitle": "حدّث تصحيح الدفعة المُعادة ثم أعد إرساله إلى قائمة المدير.",
        "reception_payment_correction_kind": "تصحيح دفعة",
        "reception_payment_save_draft": "إرسال تصحيح الدفعة للمراجعة",
        "reception_payment_correction_draft_saved": "تم إرسال مسودة تصحيح الدفعة لمراجعة المدير.",
        "reception_payment_correction_draft_approved": "تم اعتماد تصحيح الدفعة وتطبيقه على الدفعة المباشرة.",
        "reception_payment_current_snapshot": "بيانات الدفعة الحالية",
        "reception_payment_proposed_changes": "التغييرات المقترحة على الدفعة",
        "reception_payment_row_type": "نوع سطر الدفعة",
        "reception_payment_initial_row": "الدفعة الأولى",
        "reception_payment_child_row": "دفعة لاحقة",
        "reception_edit_payment_approve_confirmation_label": "أؤكد أن هذه المسودة يجب أن تحدّث الدفعة المباشرة المقفلة الآن.",
        "reception_send_treatment_correction": "إرسال تصحيح العلاج",
        "reception_treatment_correction_title": "مسودة تصحيح علاج",
        "reception_treatment_correction_subtitle": "اقترح تعديل علاج موجود بدون تعديل السجل المباشر الآن.",
        "reception_edit_treatment_title": "تعديل تصحيح العلاج المعاد",
        "reception_edit_treatment_subtitle": "حدّث تصحيح العلاج المعاد ثم أعد إرساله إلى قائمة المدير.",
        "reception_treatment_correction_kind": "تصحيح علاج",
        "reception_treatment_save_draft": "إرسال تصحيح العلاج للمراجعة",
        "reception_treatment_draft_saved": "تم إرسال مسودة تصحيح العلاج لمراجعة المدير.",
        "reception_treatment_draft_approved": "تم اعتماد تصحيح العلاج وتطبيقه على العلاج المباشر.",
        "reception_treatment_current_snapshot": "بيانات العلاج الحالية",
        "reception_treatment_proposed_changes": "التغييرات المقترحة على العلاج",
        "reception_treatment_approve_confirmation_label": "أؤكد أن هذه المسودة يجب أن تحدّث العلاج المباشر الآن.",
        "reception_send_patient_correction": "إرسال تصحيح بيانات المريض",
        "reception_patient_correction_title": "مسودة تصحيح بيانات مريض",
        "reception_patient_correction_subtitle": "اقترح تعديل بيانات ملف مريض موجود بدون تعديل السجل المباشر الآن.",
        "reception_edit_patient_title": "تعديل تصحيح المريض المعاد",
        "reception_edit_patient_subtitle": "حدّث تصحيح بيانات المريض المعاد ثم أعد إرساله إلى قائمة المدير.",
        "reception_patient_correction_kind": "تصحيح بيانات مريض",
        "reception_patient_save_draft": "إرسال تصحيح بيانات المريض للمراجعة",
        "reception_patient_draft_saved": "تم إرسال مسودة تصحيح بيانات المريض لمراجعة المدير.",
        "reception_patient_draft_approved": "تم اعتماد تصحيح بيانات المريض وتطبيقه على ملف المريض المباشر.",
        "reception_patient_current_profile": "بيانات المريض الحالية",
        "reception_patient_proposed_profile": "بيانات المريض المقترحة",
        "reception_patient_approve_confirmation_label": "أؤكد أن هذه المسودة يجب أن تحدّث ملف المريض المباشر الآن.",
        "reception_receptionist_note": "ملاحظة الاستقبال",
        "reception_draft_type_label": "نوع المسودة",
    },
}
